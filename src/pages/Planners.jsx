  ...
  return (
    <div className="container">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-thin text-gray-800">Planners</h1>
        ...
        <div className="flex justify-center mt-4">
          <div className="w-40 h-1 bg-gray-500"></div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-8">
        <div className="w-[800px] h-1 bg-gray-500"></div>
      </div>

      <h1 className='text-4xl font-thin text-gray-800 mt-5'>Frequently Bought Together</h1>
      <div><Slider/></div>
